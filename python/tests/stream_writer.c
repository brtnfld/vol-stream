...
/*
 * The live writer the Python stream tests (test_stream.py) follow. It writes
 ...
 *
 * usage: stream_writer <column|narrowing> <file> <syncdir>
 */
...
main(int argc, char **argv)
{
    ...
    if (argc != 4 || (strcmp(argv[1], "column") != 0 && strcmp(argv[1], "narrowing") != 0)) {
        fprintf(stderr, "usage: %s <column|narrowing> <file> <syncdir>\n", argv[0]);
        return 2;
    }
    column = strcmp(argv[1], "column") == 0;
